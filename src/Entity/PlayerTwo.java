...
public class PlayerTwo extends Entity{
    ...
    public PlayerTwo(GamePanel gp, KeyHandling keyH, UI ui, Characters characters){
        this.gp = gp;
        this.keyH = keyH;
        this.ui = ui;
...
//            }
        ...
        else if(keyH.specialPressed2){

            attacking = true;
            playerAction = SPECIAL_ATK;
        }
        else if(keyH.ultiPressed2){
            attacking = true;
            playerAction = ULTI;
        }
        else if(keyH.upPressed2 || keyH.downPressed2 || keyH.leftPressed2 || keyH.rightPressed2){
            if(spriteNum == 3){
                spriteNum = 1;
            }
